            ...
            <div className="account-name">
                <form action={formHandler}>
                    <div className="form-container white">
                        <label className="sr-only" htmlFor="card-nickname">
                            Nickname for card
                        </label>
                        <input
                            type="text"
                        ...
                        <label className="sr-only" htmlFor="card-owner">
                            Owner&#39;s Name on Card
                        </label>
                        <input
                            type="text"
                            placeholder="Owner&#39;s Name on Card"
                            className="account-input white"
                            id="card-owner"
                        ></input>
                        ...
                        <label className="sr-only" htmlFor="card-zipcode">
                            Billing Zip Code
                        </label>
                        <input
                            type="text"
...
const Cards = ({ user }) => {
    ...
    return (
        <>
            ...
            {showAddNewCardModal && (
                <AddNewPasswordModal onClose={handleCloseChangeNewCardModal} />
            )}
        </>
    );
};
