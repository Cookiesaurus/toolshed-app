...
const ActiveMembershipReport = dynamic(() => import("@/components/admin/reports/ActiveMembershipReport"), { ssr: false })
...
export default async function Page(){
    ...
    WHERE Membership_Status_Description = "Active";`) 
    membershipData = JSON.parse(JSON.stringify(membershipData))
    return(<>
        <ActiveMembershipReport membershipData={membershipData}/>
    </>)
}