    ...
    <div className="content">
        ...
        <form className="signup">
            <div className="section">
                <p>Please enter your personal info below:</p>
            ...
            <div className="section">
                ...
                <input className="input" placeholder={" Re-enter password"} required/>
            </div>

            <div className="section">
                <p>Please enter your account details</p>
                <input className="input" placeholder={"Address 1st line"} required/>
                <input className="input" placeholder={"Address 2nd line"}/>
                <input className="input" placeholder={"City"} required/>
                <div><select className="select" name="state" required>
                ...
                <div><select className="select" defaultValue="United States" name="country" required>
                ...
                <input className="input" type="numbers" placeholder="Zip code"/>
            ...
            <p className='basetext'>Already have an account? <a className="link" href="">Log in</a></p>
        </form>
    </div>
    </>)
}